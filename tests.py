...
class TestPcmAudio(unittest.TestCase):
    ...
    def test_addition(self):
        ...
        self.assertAlmostEqual(  # Compare lengths
            ...
            len(self.sin880 + self.sin440) / 1000,
            2,
        )
    ...
    def test_loop(self):
        ...
        self.assertEqual(
            2 * (self.sin880 + self.sin880),
            2 * self.sin880 + 2 * self.sin880,
        )

        # ... but it does not really.
        self.assertNotEqual(
            2 * (self.sin880 + self.sin440),
    ...
    def test_sliced_length(self):
        ...
        self.assertEqual(500, len(self.sin440[-600:-100]))  # Negative range
    ...
    def test_max(self):
        ...
        self.assertLess(MUTE, self.sin440.max(), "Sine waves should not be mute")
    ...
    def test_dbfs(self):
        ...
        self.assertLess(MUTE, self.sin440.dbfs(), "Sine waves should not be mute")
    ...
    def test_gain(self):
        ...
        self.assertEqual(MUTE, (self.sin440 + MUTE).max())  # Mute down
    ...
    def test_invert(self):
        self.assertEqual(MUTE, (self.sin440 & self.sin440.invert()).max())
